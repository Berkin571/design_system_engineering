...
var import_devkit2, import_cosmiconfig, import_dedent2, import_fs2, import_glob_parent, import_globby2, import_js_yaml, import_load_json_file2, import_npmlog8, import_p_map2, import_path4, LICENSE_GLOB, Project, getPackages, getPackagesSync;
...
var import_npmlog9, import_os, import_path5, import_write_file_atomic;
...
var import_devkit3, import_fs_extra, import_lodash3, import_minimatch2, import_npm_package_arg2, import_path7, import_semver2, resolvePackage;
...
var import_npm_package_arg3, import_npmlog13, import_pify;
...
var require_types = __commonJS({
  "libs/core/src/lib/npm-conf/types.ts"(exports2) {
    ...
    exports2.types = {
      ...
      cafile: import_path12.default,
      cache: import_path12.default,
      ...
      global: Boolean,
      globalconfig: import_path12.default,
      ...
      "init-module": import_path12.default,
      ...
      tag: String,
      timing: Boolean,
      tmp: import_path12.default,
      unicode: Boolean,
      "unsafe-perm": Boolean,
      "update-notifier": Boolean,
      usage: Boolean,
      user: [Number, String],
      userconfig: import_path12.default,
      umask: Umask,
      version: Boolean,
...
var require_defaults = __commonJS({
  "libs/core/src/lib/npm-conf/defaults.ts"(exports2) {
    ...
    if (home) {
      ...
      home = import_path12.default.resolve(temp, `npm-${uidOrPid}`);
    }
    var cacheExtra = process.platform === "win32" ? "npm-cache" : ".npm";
    var cacheRoot = process.platform === "win32" && process.env["APPDATA"] || home;
    var cache = import_path12.default.resolve(cacheRoot, cacheExtra);
    var defaults;
    var globalPrefix;
    Object.defineProperty(exports2, "defaults", {
      get() {
        ...
        if (process.env["PREFIX"]) {
          ...
          globalPrefix = import_path12.default.dirname(process.execPath);
        } else {
          globalPrefix = import_path12.default.dirname(import_path12.default.dirname(process.execPath));
          if (process.env["DESTDIR"]) {
            globalPrefix = import_path12.default.join(process.env["DESTDIR"], globalPrefix);
          }
        }
        defaults = {
          access: null,
          ...
          "commit-hooks": true,
          global: false,
          globalconfig: import_path12.default.resolve(globalPrefix, "etc", "npmrc"),
          "global-style": false,
          ...
          "init-module": import_path12.default.resolve(home, ".npm-init.js"),
          "init-author-name": "",
          "init-author-email": "",
          "init-author-url": "",
          "init-version": "1.0.0",
          ...
          userconfig: import_path12.default.resolve(home, ".npmrc"),
...
var require_npm_conf = __commonJS({
  "libs/core/src/lib/npm-conf/index.ts"(exports2, module2) {
    ...
    function npmConf3(opts) {
      ...
      conf.addEnv();
      conf.loadPrefix();
      const projectConf = import_path12.default.resolve(conf["localPrefix"], ".npmrc");
      ...
      if (conf["get"]("prefix")) {
        const etc = import_path12.default.resolve(conf["get"]("prefix"), "etc");
        conf.root.globalconfig = import_path12.default.resolve(etc, "npmrc");
        conf.root.globalignorefile = import_path12.default.resolve(etc, "npmignore");
      }
...
var import_fs_extra5, import_libnpmpublish, import_npm_package_arg5, import_npmlog25, import_pify2, readJSON, readJSONAsync;
...
var import_graceful_fs, import_is_stream, import_make_dir, import_path11, import_temp_dir, import_util, uuid, writeFileP, tempfile, writeStream;
var init_temp_write = __esm({
  "libs/core/src/lib/temp-write.ts"() {
    ...
    tempfile = (filePath) => import_path11.default.join(import_temp_dir.default, uuid.v4(), filePath || "");
...
var import_npm_packlist, import_npmlog28, import_tar2;
...
var import_node_fetch, import_npmlog33;
...
function getLastCommit(execOpts) {
  if (hasTags2(execOpts)) {
    import_npmlog36.default.silly("getLastTagInBranch", "");
    return childProcess10.execSync("git", ["describe", "--tags", "--abbrev=0"], execOpts);
  }
  import_npmlog36.default.silly("getFirstCommit", "");
  return childProcess10.execSync("git", ["rev-list", "--max-parents=0", "HEAD"], execOpts);
}
function hasTags2(opts) {
  ...
  import_npmlog36.default.verbose("hasTags", result.toString());
  return result;
}
...
function hasCommit(opts) {
  import_npmlog37.default.silly("hasCommit", "");
  let retVal;
  try {
  ...
  import_npmlog37.default.verbose("hasCommit", retVal.toString());
  return retVal;
}
var import_npmlog37, childProcess11;
...
var require_src = __commonJS({
  "libs/commands/diff/src/index.ts"(exports2, module2) {
    ...
    init_has_commit();
    var childProcess12 = require("@lerna/child-process");
    ...
    var DiffCommand = class extends Command {
      ...
      execute() {
        return childProcess12.spawn("git", this.args, this.execOpts).catch((err) => {
          if (err.exitCode) {
            throw err;
          }
        });
