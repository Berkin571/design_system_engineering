...
function getCycles(dependencies) {
  ...
  function dfs(next, path11) {
    visited.add(next);
    path11.push(next);
    for (const dep of dependencies[next] || []) {
      if (path11.includes(dep)) {
        const cycle = path11.slice(path11.indexOf(dep));
        cycles.push(cycle);
...
function formatColumns(resultList, viewOptions) {
  const formattedResults = resultList.map((project) => {
    ...
    if (pkg.version) {
      formatted.version = import_chalk2.default.green(`v${pkg.version}`);
    } else {
    ...
    formatted.location = import_chalk2.default.grey(import_path9.default.relative(".", pkg.location));
    return formatted;
  });
  return trimmedColumns(formattedResults, viewOptions);
}
var import_chalk2, import_columnify, import_path9;
...
var require_types = __commonJS({
  "libs/core/src/lib/npm-conf/types.ts"(exports2) {
    ...
    exports2.types = {
      ...
      cafile: import_path14.default,
      cache: import_path14.default,
      ...
      global: Boolean,
      globalconfig: import_path14.default,
      ...
      "init-module": import_path14.default,
      ...
      tag: String,
      timing: Boolean,
      tmp: import_path14.default,
      unicode: Boolean,
      "unsafe-perm": Boolean,
      "update-notifier": Boolean,
      usage: Boolean,
      user: [Number, String],
      userconfig: import_path14.default,
      umask: Umask,
      version: Boolean,
...
var require_defaults = __commonJS({
  "libs/core/src/lib/npm-conf/defaults.ts"(exports2) {
    ...
    if (home) {
      ...
      home = import_path14.default.resolve(temp, `npm-${uidOrPid}`);
    }
    var cacheExtra = process.platform === "win32" ? "npm-cache" : ".npm";
    var cacheRoot = process.platform === "win32" && process.env["APPDATA"] || home;
    var cache = import_path14.default.resolve(cacheRoot, cacheExtra);
    var defaults;
    var globalPrefix;
    Object.defineProperty(exports2, "defaults", {
      get() {
        ...
        if (process.env["PREFIX"]) {
          ...
          globalPrefix = import_path14.default.dirname(process.execPath);
        } else {
          globalPrefix = import_path14.default.dirname(import_path14.default.dirname(process.execPath));
          if (process.env["DESTDIR"]) {
            globalPrefix = import_path14.default.join(process.env["DESTDIR"], globalPrefix);
          }
        }
        defaults = {
          access: null,
          ...
          "commit-hooks": true,
          global: false,
          globalconfig: import_path14.default.resolve(globalPrefix, "etc", "npmrc"),
          "global-style": false,
          ...
          "init-module": import_path14.default.resolve(home, ".npm-init.js"),
          "init-author-name": "",
          "init-author-email": "",
          "init-author-url": "",
          "init-version": "1.0.0",
          ...
          userconfig: import_path14.default.resolve(home, ".npmrc"),
...
var require_npm_conf = __commonJS({
  "libs/core/src/lib/npm-conf/index.ts"(exports2, module2) {
    ...
    function npmConf3(opts) {
      ...
      conf.addEnv();
      conf.loadPrefix();
      const projectConf = import_path14.default.resolve(conf["localPrefix"], ".npmrc");
      ...
      if (conf["get"]("prefix")) {
        const etc = import_path14.default.resolve(conf["get"]("prefix"), "etc");
        conf.root.globalconfig = import_path14.default.resolve(etc, "npmrc");
        conf.root.globalignorefile = import_path14.default.resolve(etc, "npmignore");
      }
...
var import_graceful_fs, import_is_stream, import_make_dir, import_path13, import_temp_dir, import_util2, uuid, writeFileP, tempfile, writeStream;
