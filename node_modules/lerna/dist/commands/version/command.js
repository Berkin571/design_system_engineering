...
function collectUncommitted({ cwd, log: log43 = import_npmlog.default }) {
  log43.silly("collect-uncommitted", "git status --porcelain (async)");
...
var import_node_fetch, import_npmlog33, import_path14, GitLabClient;
...
var import_devkit5, import_fs5, import_npmlog37, import_path15, import_slash2, childProcess11, resolvedPrettier;
...
var import_devkit6, import_load_json_file3, import_npmlog44, import_path16;
...
var require_command = __commonJS({
  "libs/commands/version/src/command.ts"(exports2, module2) {
    "use strict";
    var import_npmlog45 = __toESM(require("npmlog"));
    var import_semver8 = __toESM(require("semver"));
    ...
    var command = {
      ...
      builder(yargs2, composed) {
        ...
        return yargs2.option("ignore", {
          ...
          if (argv["--"]) {
            import_npmlog45.default.warn("EDOUBLEDASH", "Arguments after -- are no longer passed to subprocess executions.");
            import_npmlog45.default.warn("EDOUBLEDASH", "This will cause an error in a future major version.");
          }
          return argv;
        });
      },
